...
export const trennbareVerben = [
  {
    "id": "trennbar-haeufig",
    "titleAr": "أفعال مركّبة منفصلة (الأكثر استعمالاً)",
    "titleDe": "Trennbare Verben",
    "intro": "الأفعال المنفصلة: في الحاضر والماضي البسيط (Präteritum) **تنفصل البادئة** وتذهب إلى نهاية الجملة. في Perfekt و Infinitiv تبقى موصولة. مثال: anrufen → ich rufe an / ich habe angerufen.",
    "verbs": [
      {
        "infinitiv": "anrufen",
        "praeteritum": "rief … an",
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich rufe meinen Vater jeden Tag an.",
            "ar": "أتّصل بأبي كل يوم."
          },
          {
            "context": "Perfekt",
            "de": "Hast du den Arzt schon angerufen?",
            "ar": "هل اتّصلت بالطبيب؟"
          },
          {
            "context": "Konjunktiv II",
            "de": "Würdest du mich später anrufen?",
            "ar": "هل يمكنك الاتصال بي لاحقاً؟"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich stehe um 6 Uhr auf.",
            "ar": "أستيقظ الساعة 6."
          },
          {
            "context": "Perfekt",
            "de": "Heute bin ich sehr früh aufgestanden.",
            "ar": "استيقظت اليوم باكراً جداً."
          },
          {
            "context": "Modal",
            "de": "Morgen muss ich um 5 Uhr aufstehen.",
            "ar": "غداً يجب أن أستيقظ الساعة 5."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich kaufe samstags im Supermarkt ein.",
            "ar": "أتسوّق يوم السبت في السوبرماركت."
          },
          {
            "context": "Perfekt",
          ...
          {
            "context": "Modal",
            "de": "Wir müssen für die Woche einkaufen.",
            "ar": "علينا أن نتسوّق للأسبوع."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich lade dich zu meinem Geburtstag ein.",
            "ar": "أدعوك إلى عيد ميلادي."
          },
          {
            "context": "Perfekt",
            "de": "Wir haben alle Freunde eingeladen.",
            "ar": "دعونا كل الأصدقاء."
          },
          {
            "context": "Passiv",
            "de": "Er wurde nicht eingeladen.",
            "ar": "هو لم يُدعَ."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Kommst du mit ins Kino?",
            "ar": "هل ستأتي معي إلى السينما؟"
          },
          {
            "context": "Perfekt",
            "de": "Sie ist mit uns mitgekommen.",
            "ar": "هي أتت معنا."
          },
          {
            "context": "Modal",
            "de": "Ich möchte gern mitkommen.",
            "ar": "أحبّ أن آتي معك."
          }
        ]
      },
      {
        ...
        "examples": [
          ...
          {
            "context": "Perfekt",
            "de": "Hast du dein Buch mitgenommen?",
            "ar": "هل أخذت كتابك معك؟"
          },
          {
            "context": "Imperativ",
            "de": "Nimm bitte deinen Pass mit!",
            "ar": "خذ جواز سفرك معك!"
          }
        ]
      },
      {
        "infinitiv": "aufmachen / zumachen",
        "praeteritum": "machte … auf / zu",
        "partizip2": "aufgemacht / zugemacht",
        "hilfsverb": "haben",
        "ar": "يفتح / يغلق",
        "type": "trennbar",
        "examples": [
          {
            "context": "Präsens",
            "de": "Mach bitte das Fenster auf!",
            "ar": "افتح النافذة من فضلك!"
          },
          {
            "context": "Imperativ",
            "de": "Mach die Tür zu, es ist kalt.",
            "ar": "أغلق الباب، الجو بارد."
          },
          {
            "context": "Perfekt",
            "de": "Wer hat den Brief aufgemacht?",
            "ar": "من فتح الرسالة؟"
          }
        ]
      },
      {
        "infinitiv": "anziehen / ausziehen",
        "praeteritum": "zog … an / aus",
        "partizip2": "angezogen / ausgezogen",
        "hilfsverb": "haben",
        "ar": "يلبس / يخلع",
        "type": "trennbar",
        "examples": [
          {
            "context": "Präsens",
            "de": "Sie zieht sich elegant an.",
            "ar": "هي ترتدي أناقة."
          },
          {
            "context": "Imperativ",
            "de": "Zieh deine Jacke aus!",
            "ar": "اخلع جاكيتك!"
          },
          {
            "context": "Perfekt",
            "de": "Ich habe meinen Mantel angezogen.",
            "ar": "لبست معطفي."
          }
        ]
      },
        ...
        "examples": [
          {
            ...
            "ar": "نشاهد التلفاز في المساء."
          },
          {
            "context": "Perfekt",
            "de": "Er hat den ganzen Abend ferngesehen.",
            "ar": "هو شاهد التلفاز طوال المساء."
          },
          {
            "context": "Negation",
            "de": "Heute sehe ich nicht fern.",
            "ar": "اليوم لن أشاهد التلفاز."
          }
        ]
      },
      {
        ...
        "partizip2": "umgezogen",
        "hilfsverb": "sein",
        "ar": "ينتقل (بيت) / يبدّل ملابسه",
        "type": "trennbar",
        "examples": [
          {
            "context": "Wohnung wechseln",
            "de": "Wir ziehen nächsten Monat nach München um.",
            "ar": "سننتقل الشهر القادم إلى ميونخ."
          },
          {
            "context": "Perfekt (Wohnung)",
            "de": "Sie ist letztes Jahr umgezogen.",
            "ar": "هي انتقلت السنة الماضية."
          },
          {
            "context": "Kleidung wechseln",
            "de": "Ich muss mich noch umziehen.",
            "ar": "لا يزال عليّ أن أبدّل ملابسي."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Der Zug kommt um 17 Uhr an.",
            "ar": "القطار يصل الساعة 17."
          },
          {
            "context": "Perfekt",
            "de": "Wann bist du in Berlin angekommen?",
            "ar": "متى وصلت إلى برلين؟"
          },
          {
            "context": "Frage",
            "de": "Ist das Paket schon angekommen?",
            "ar": "هل وصل الطرد؟"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Der Bus fährt in 5 Minuten ab.",
            "ar": "الباص يغادر بعد 5 دقائق."
          },
          {
            "context": "Perfekt",
            "de": "Der Zug ist pünktlich abgefahren.",
            "ar": "القطار غادر في موعده."
          },
          {
            "context": "Frage",
            "de": "Wann fährt dein Flugzeug ab?",
            "ar": "متى تغادر طائرتك؟"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Imperativ",
            "de": "Pass auf! Da kommt ein Auto!",
            "ar": "انتبه! هناك سيارة قادمة!"
          },
          {
            "context": "Präsens + auf",
            "de": "Sie passt auf die Kinder auf.",
            "ar": "هي تعتني بالأطفال."
          },
          {
            "context": "Perfekt",
            "de": "Hast du gut aufgepasst?",
            "ar": "هل انتبهت جيداً؟"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Heute Abend gehen wir aus.",
            "ar": "الليلة سنخرج."
          },
          {
            "context": "Perfekt",
            "de": "Am Wochenende sind wir oft ausgegangen.",
            "ar": "كنا نخرج كثيراً في عطلة الأسبوع."
          },
          {
            "context": "Modal",
            "de": "Ich möchte heute ausgehen.",
            "ar": "أودّ الخروج اليوم."
          }
        ]
      },
      {
        "infinitiv": "ausmachen",
        "praeteritum": "machte … aus",
        ...
        "examples": [
          ...
          {
            "context": "Termin",
            "de": "Wir haben für Samstag was ausgemacht.",
            "ar": "اتفقنا على شيء يوم السبت."
          },
          {
            "context": "Perfekt",
            "de": "Hast du das Licht ausgemacht?",
            "ar": "هل أطفأت الضوء؟"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Du siehst heute müde aus.",
            "ar": "تبدو متعباً اليوم."
          },
          {
            "context": "Perfekt",
            "de": "Sie hat sehr glücklich ausgesehen.",
            "ar": "بدت سعيدة جداً."
          },
          {
            "context": "Frage",
            "de": "Wie sieht es draußen aus?",
            "ar": "كيف يبدو الطقس بالخارج؟"
          }
        ]
      },
      {
        "infinitiv": "mitmachen",
        "praeteritum": "machte … mit",
        "partizip2": "mitgemacht",
        "hilfsverb": "haben",
        "ar": "يشارك",
        "type": "trennbar",
        "examples": [
          {
            "context": "Präsens",
            "de": "Machst du beim Sport mit?",
            "ar": "هل تشارك في الرياضة؟"
          },
          {
            "context": "Perfekt",
            "de": "Ich habe beim Wettbewerb mitgemacht.",
            "ar": "شاركت في المسابقة."
          },
          {
            "context": "Modal",
        ...
        "examples": [
          {
            ...
            "ar": "أحضّر نفسي للامتحان."
          },
          {
            "context": "Perfekt",
            "de": "Hast du das Essen vorbereitet?",
            "ar": "هل حضّرت الطعام؟"
          },
          {
            "context": "Modal",
            "de": "Wir müssen alles vorbereiten.",
            "ar": "علينا أن نحضّر كل شيء."
          }
        ]
      },
      {
        "infinitiv": "vorhaben",
        "praeteritum": "hatte … vor",
        "partizip2": "vorgehabt",
        "hilfsverb": "haben",
        "ar": "ينوي / يخطّط لـ",
        "type": "trennbar",
        "examples": [
          {
            ...
            "ar": "ماذا تنوي في عطلة الأسبوع؟"
          },
          {
            "context": "Antwort",
            "de": "Ich habe vor, ins Kino zu gehen.",
            "ar": "أنوي الذهاب إلى السينما."
          },
          {
            "context": "Perfekt",
            "de": "Wir haben das schon lange vorgehabt.",
            "ar": "كنا ننوي ذلك منذ زمن."
          }
        ]
      },
      {
        "infinitiv": "zurückkommen",
        "praeteritum": "kam … zurück",
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich komme um 18 Uhr zurück.",
            "ar": "أعود الساعة 18."
          },
          {
            "context": "Perfekt",
            "de": "Wann seid ihr zurückgekommen?",
            "ar": "متى عدتم؟"
          },
          {
            "context": "Frage",
            "de": "Kommst du heute Abend zurück?",
            "ar": "هل ستعود الليلة؟"
          }
        ]
      }
  ...
  {
    "id": "untrennbar",
    "titleAr": "أفعال مركّبة لا تنفصل (Untrennbare Verben)",
    "titleDe": "Untrennbare Verben",
    "intro": "الأفعال غير المنفصلة لا تتجزّأ أبداً. بادئاتها: **be-, ge-, er-, ver-, zer-, ent-, emp-, miss-**. مهم جداً: في Perfekt **بدون -ge-**! مثال: verstehen → verstanden (وليس geverstanden).",
    "verbs": [
      {
        "infinitiv": "verstehen",
      ...
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich bekomme jeden Monat ein Gehalt.",
            "ar": "أتقاضى راتباً كل شهر."
          },
          {
            "context": "Perfekt",
          ...
          {
            "context": "ATTN",
            "de": "\"bekommen\" ≠ \"werden\"! \"Ich bekomme einen Brief\" = أستلم رسالة.",
            "ar": "⚠️ خطأ شائع."
          }
        ]
      },
        ...
        "examples": [
          {
            ...
            "ar": "الدورة تبدأ الساعة 9."
          },
          {
            "context": "Perfekt",
            "de": "Wann hat der Film begonnen?",
            "ar": "متى بدأ الفيلم؟"
          },
          {
            "context": "Modal",
            "de": "Wir wollen morgen mit der Arbeit beginnen.",
            "ar": "نريد البدء بالعمل غداً."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            ...
            "ar": "المدرّس يشرح القاعدة."
          },
          {
            "context": "Perfekt",
            "de": "Er hat mir das genau erklärt.",
            "ar": "هو شرح لي ذلك بدقّة."
          },
          {
            "context": "Bitte",
            "de": "Können Sie mir das bitte erklären?",
            "ar": "هل يمكنكم شرح ذلك لي؟"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich vergesse oft meine Schlüssel.",
            "ar": "أنسى مفاتيحي كثيراً."
          },
          {
            "context": "Perfekt",
            "de": "Ich habe deinen Geburtstag vergessen!",
            "ar": "نسيت عيد ميلادك!"
          },
          {
            "context": "Modal",
            "de": "Vergiss nicht, mich anzurufen.",
            "ar": "لا تنسَ الاتّصال بي."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich verliere immer meine Brille.",
            "ar": "دائماً أفقد نظارتي."
          },
          {
            "context": "Perfekt",
            "de": "Wir haben das Spiel verloren.",
            "ar": "خسرنا المباراة."
          },
          {
            "context": "Frage",
            "de": "Hast du etwas verloren?",
            "ar": "هل فقدت شيئاً؟"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Sie verkauft ihr altes Auto.",
            "ar": "تبيع سيارتها القديمة."
          },
          {
            "context": "Perfekt",
            "de": "Wir haben das Haus letztes Jahr verkauft.",
            "ar": "بعنا البيت السنة الماضية."
          },
          {
            "context": "Anzeige",
            "de": "Verkaufe Sofa, gut erhalten.",
            "ar": "للبيع: كنبة، حالة جيدة."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Sie erzählt eine Geschichte.",
            "ar": "هي تحكي قصة."
          },
          {
            "context": "Perfekt",
            "de": "Hat er dir alles erzählt?",
            "ar": "هل قصّ لك كل شيء؟"
          },
          {
            "context": "Bitte",
            "de": "Erzähl mir von deinem Urlaub!",
            "ar": "احكِ لي عن إجازتك!"
          }
        ]
      },
      {
        ...
        "examples": [
          {
            ...
            "ar": "من سيفوز بالمباراة؟"
          },
          {
            "context": "Perfekt",
            "de": "Sie hat den ersten Preis gewonnen!",
            "ar": "فازت بالجائزة الأولى!"
          },
          {
            "context": "Lotto",
            "de": "Wenn ich gewinnen würde, …",
            "ar": "لو ربحت..."
          }
        ]
      },
      {
        ...
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich empfehle dir dieses Buch.",
            "ar": "أنصحك بهذا الكتاب."
          },
          {
            "context": "Perfekt",
            "de": "Ein Freund hat mir den Arzt empfohlen.",
            "ar": "صديق نصحني بالطبيب."
          },
          {
            "context": "Frage",
      ...
      },
      {
        ...
        "examples": [
          {
            "context": "Reflexiv",
            "de": "Ich habe mich entschieden, zu bleiben.",
            "ar": "قرّرت البقاء."
          },
          {
            "context": "Frage",
            "de": "Hast du dich schon entschieden?",
            "ar": "هل قرّرت بعد؟"
          },
          {
            "context": "Modal",
            "de": "Ich kann mich nicht entscheiden.",
            "ar": "لا أستطيع أن أقرّر."
          }
        ]
      },
      {
        "infinitiv": "besuchen",
        "praeteritum": "besuchte",
        "partizip2": "besucht",
        "hilfsverb": "haben",
        "ar": "يزور",
        "type": "untrennbar",
        "examples": [
          {
            "context": "Präsens",
            "de": "Ich besuche meine Eltern jedes Wochenende.",
            "ar": "أزور أهلي كل عطلة أسبوع."
          },
          {
            "context": "Perfekt",
            "de": "Hast du Berlin schon besucht?",
            "ar": "هل زرت برلين؟"
          },
          {
            "context": "Modal",
            "de": "Ich möchte dich besuchen.",
            "ar": "أودّ زيارتك."
          }
        ]
      },
      ...
      },
      {
        ...
        "partizip2": "gehört",
        "hilfsverb": "haben",
        "ar": "يخصّ / ملك لـ (+ Dativ)",
        "type": "untrennbar",
        "examples": [
          {
            "context": "Frage",
            "de": "Wem gehört das Auto?",
            "ar": "لمن السيارة؟"
          },
          {
            "context": "Antwort",
            "de": "Das Auto gehört mir.",
            "ar": "السيارة لي."
          },
          {
            "context": "Familie",
            "de": "Du gehörst zu unserer Familie.",
            "ar": "أنت من عائلتنا."
          }
        ]
      },
        ...
        "examples": [
          {
            ...
            "ar": "التدخين هنا غير مسموح."
          },
          {
            "context": "Perfekt",
            "de": "Mein Vater hat mir das erlaubt.",
            "ar": "سمح لي والدي بذلك."
          },
          {
            "context": "Frage",
            "de": "Darf ich? – Ja, das ist erlaubt.",
            "ar": "هل يسمح لي؟ – نعم، مسموح."
          }
        ]
      }
    ]
  ...
  {
    "id": "gemischt",
    "titleAr": "أفعال تتغيّر معانيها (نفس الجذر مع بادئات مختلفة)",
    "titleDe": "Gleicher Stamm – andere Bedeutung",
    "intro": "تنبّه: نفس الجذر مع بادئة مختلفة قد يغيّر المعنى تماماً! تعلّم هذه المجموعات سويّاً.",
    "verbs": [
      {
        "infinitiv": "kommen / ankommen / mitkommen / wiederkommen",
        "praeteritum": "kam / kam an / kam mit / kam wieder",
        "partizip2": "gekommen / angekommen / mitgekommen / wiedergekommen",
        "hilfsverb": "sein",
        "ar": "يأتي / يصل / يأتي مع / يعود",
        "type": "gemischt",
        "examples": [
          {
            "context": "kommen",
          ...
          {
            "context": "ankommen",
            "de": "Ich komme um 8 Uhr in Berlin an.",
            "ar": "أصل إلى برلين الساعة 8."
          },
          {
            "context": "mitkommen",
            "de": "Kommst du mit?",
      ...
      {
        "infinitiv": "fahren / abfahren / mitfahren / hinfahren",
        "praeteritum": "fuhr / fuhr ab / fuhr mit / fuhr hin",
        "partizip2": "gefahren / abgefahren / mitgefahren / hingefahren",
        "hilfsverb": "sein",
        "ar": "يقود/يسافر / يغادر / يسافر مع / يذهب إلى هناك",
        "type": "gemischt",
        "examples": [
          {
            "context": "fahren",
            "de": "Ich fahre nach Hamburg.",
            "ar": "أسافر إلى هامبورغ."
          },
          {
            "context": "abfahren",
            "de": "Der Bus fährt um 9 ab.",
            "ar": "الباص يغادر الساعة 9."
          },
          {
            "context": "mitfahren",
            "de": "Kann ich mit dir mitfahren?",
            "ar": "هل أستطيع السفر معك؟"
          }
        ]
      },
      {
        "infinitiv": "machen / aufmachen / zumachen / mitmachen / ausmachen",
        "praeteritum": "machte / machte auf / machte zu / machte mit / machte aus",
        "partizip2": "gemacht / aufgemacht / zugemacht / mitgemacht / ausgemacht",
        "hilfsverb": "haben",
        "ar": "يفعل / يفتح / يغلق / يشارك / يطفئ",
        "type": "gemischt",
        "examples": [
          {
            "context": "machen",
      ...
      {
        "infinitiv": "stehen / aufstehen / verstehen / bestehen",
        "praeteritum": "stand / stand auf / verstand / bestand",
        "partizip2": "gestanden / aufgestanden / verstanden / bestanden",
        "hilfsverb": "haben",
        "ar": "يقف / يستيقظ / يفهم / ينجح بـ (امتحان)",
        "type": "gemischt",
        "examples": [
          {
            "context": "aufstehen",
            "de": "Ich stehe um 6 auf.",
            "ar": "أستيقظ الساعة 6."
          },
          {
            "context": "verstehen",
            "de": "Ich verstehe alles.",
            "ar": "أفهم كل شيء."
          },
          {
            "context": "bestehen",
            "de": "Sie hat die Prüfung bestanden!",
            "ar": "نجحت في الامتحان!"
          }
        ]
      }
...
export const satzbau = [
  {
    ...
    "ar": "أتعلّم الألمانية كل يوم.",
    "tipAr": "في الجملة البسيطة: الفاعل (Ich) ثم الفعل المصرّف (lerne) ثم بقيّة المعلومات."
  },
  {
    "id": "l1-2",
    "level": 1,
  ...
  },
  {
    ...
    "ar": "نحن نذهب غداً إلى السينما.",
    "tipAr": "الزمن (morgen) يأتي عادة بعد الفعل وقبل المكان."
  },
  {
    "id": "l1-4",
    "level": 1,
  ...
  },
  {
    ...
    "ar": "اليوم الطقس جميل جداً.",
    "tipAr": "لو بدأت بظرف زمان (Heute)، الفعل يبقى في الموقع الثاني."
  },
  {
    "id": "l1-6",
    "level": 1,
  ...
  },
  {
    ...
    "ar": "في عطلة الأسبوع أزور أصدقائي.",
    "tipAr": "بعد ظرف الزمان (Am Wochenende) يأتي الفعل ثم الفاعل (انعكاس)."
  },
  {
    "id": "l2-1",
    "level": 2,
    ...
    "ar": "يجب أن أستيقظ مبكراً اليوم.",
    "tipAr": "مع الأفعال الناقصة (muss, will, kann …)، المصدر يذهب لآخر الجملة."
  },
  {
    "id": "l2-2",
    "level": 2,
    ...
    "ar": "هو يستطيع التحدّث بالألمانية جيّداً."
  },
  {
    "id": "l2-3",
    "level": 2,
    ...
    "ar": "نريد القيام برحلة يوم الأحد."
  },
  {
    "id": "l2-4",
    "level": 2,
    ...
    "ar": "سأتّصل بك غداً.",
    "tipAr": "الفعل المنفصل (anrufen): تصرّفه (rufe) في الموقع الثاني، والبادئة (an) لآخر الجملة."
  },
  {
    "id": "l2-5",
    "level": 2,
    ...
    "ar": "القطار ينطلق الساعة الثامنة.",
    "tipAr": "abfahren فعل منفصل: ab تذهب لآخر الجملة."
  },
  {
    "id": "l2-6",
    "level": 2,
  ...
  },
  {
    ...
    "ar": "شاهدنا فيلماً البارحة.",
    "tipAr": "في Perfekt: المساعد (haben/sein) في الموقع الثاني، Partizip II (gesehen) لآخر الجملة."
  },
  {
    "id": "l2-9",
    "level": 2,
    ...
    "ar": "استيقظت الساعة السابعة.",
    "tipAr": "aufstehen → بـ sein في Perfekt (يدلّ على حركة/تغيّر حالة)."
  },
  {
    "id": "l3-1",
    "level": 3,
    ...
    "ar": "أتعلّم الألمانية لأنّي أريد العيش في ألمانيا.",
    "tipAr": "بعد weil: الفعل المصرّف يذهب لآخر الجملة الفرعيّة."
  },
  {
    "id": "l3-2",
    "level": 3,
    ...
    "ar": "هي تقول إنّها متعبة.",
    "tipAr": "بعد dass: الفعل المصرّف (ist) في آخر الجملة."
  },
  {
    "id": "l3-3",
    "level": 3,
    ...
    "ar": "رغم أنّها تمطر، نذهب للنزهة.",
    "tipAr": "لمّا تبدأ الجملة بـ obwohl، الفعل في الجملة الرئيسيّة (gehen) يأتي مباشرة بعد الفاصلة."
  },
  {
    "id": "l3-4",
    "level": 3,
  ...
  },
  {
    ...
    "ar": "عندما يكون لديّ وقت، أزور والديّ.",
    "tipAr": "بعد wenn الفعل لآخر الجملة، وفي الرئيسيّة الفعل يأتي مباشرة بعد الفاصلة."
  },
  {
    "id": "l3-6",
    "level": 3,
  ...
  },
  {
    ...
    "ar": "هذا هو الرجل الذي اتّصل البارحة.",
    "tipAr": "في Relativsatz: الضمير (der) يطابق جنس وعدد الكلمة المرجعيّة، والفعل لآخر الجملة الفرعيّة."
  },
  {
    "id": "l4-2",
    "level": 4,
    ...
    "ar": "المرأة التي رأيتها هي معلّمتي.",
    "tipAr": "die في الـ Akkusativ هنا (ich → habe gesehen → die Frau)."
  },
  {
    "id": "l4-3",
    "level": 4,
    ...
    "ar": "السيّارة التي اشتريتها سريعة جداً."
  },
  {
    "id": "l4-4",
    "level": 4,
    ...
    "ar": "لو كان لديّ مال، لسافرت رحلة.",
    "tipAr": "Konjunktiv II: hätte + würde … machen — للتعبير عن المستحيل/الافتراضي."
  },
  {
    "id": "l4-5",
    "level": 4,
    ...
    "ar": "أنا سعيد لأنّك جئت.",
    "tipAr": "sich freuen + dass-Satz: الفعل المركّب (gekommen bist) لآخر الجملة الفرعيّة."
  },
  {
    "id": "l4-6",
    "level": 4,
    ...
    "ar": "يعمل في الشركة التي يعمل فيها أبوه أيضاً.",
    "tipAr": "مع حرف جرّ + Relativpronomen (in der …)، الفعل لآخر الجملة الفرعيّة."
  }
];
