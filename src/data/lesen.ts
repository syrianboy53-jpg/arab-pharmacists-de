...
export const lesenModels = [
  ...
  {
    "id": "lesen-10",
    "title": "Lesen 10 – التكنولوجيا والإنترنت",
    "description": "مدوّنات عن الذكاء الاصطناعي، مقال عن الأمن الرقمي، إعلانات تقنيّة، وقواعد استخدام مكتبة.",
    "parts": [
      {
        "type": "match-blog",
        "title": "Teil 1 – مدوّنات عن الذكاء الاصطناعي",
        "instructionsAr": "اقرأ 5 مشاركات قصيرة في منتدى عن \"الذكاء الاصطناعي في الحياة اليوميّة\". بعدها اقرأ 6 جمل واختر من أيّ شخص (A-E).",
        "texts": [
          {
            "id": "A",
            "titleDe": "Amira",
            "titleAr": "أميرة",
            "textDe": "Ich nutze ChatGPT jeden Tag, um meine deutschen Texte zu verbessern. Es korrigiert meine Grammatik und schlägt bessere Wörter vor. Mein Sprachkurs-Lehrer ist beeindruckt von meinem Fortschritt."
          },
          {
            "id": "B",
            "titleDe": "Bashir",
            "titleAr": "بشير",
            "textDe": "Ich finde KI gefährlich. Viele Menschen verlieren ihre Jobs, weil Computer schneller und billiger arbeiten. Politiker müssen Gesetze machen, die uns schützen."
          },
          {
            "id": "C",
            "titleDe": "Carmen",
            "titleAr": "كارمن",
            "textDe": "Als Ärztin nutze ich KI zur Diagnose. Sie erkennt Krebs auf Röntgenbildern besser als viele Kollegen. Aber die letzte Entscheidung trifft immer noch der Mensch."
          },
          {
            "id": "D",
            "titleDe": "David",
            "titleAr": "دافيد",
            "textDe": "Mein Sohn (10) chattet stundenlang mit KI-Charakteren. Er hat kaum noch echte Freunde. Ich mache mir Sorgen um seine soziale Entwicklung."
          },
          {
            "id": "E",
            "titleDe": "Eva",
            "titleAr": "إيفا",
            "textDe": "Ich verkaufe Kunst online — aber meine Kunden bestellen jetzt KI-generierte Bilder, die viel billiger sind. Mein Beruf stirbt langsam."
          }
        ],
        "statements": [
          {
            "id": "lesen-10-1-1",
            "textDe": "Diese Person nutzt KI beruflich für medizinische Zwecke.",
            "textAr": "يستخدم KI في عمله الطبّي.",
            "correctAd": "C"
          },
          {
            "id": "lesen-10-1-2",
            "textDe": "Diese Person hat Angst, dass KI viele Arbeitsplätze ersetzt.",
            "textAr": "يخاف من فقدان الوظائف.",
            "correctAd": "B"
          },
          {
            "id": "lesen-10-1-3",
            "textDe": "Diese Person verliert wegen KI Kunden.",
            "textAr": "يفقد زبائن بسبب KI.",
            "correctAd": "E"
          },
          {
            "id": "lesen-10-1-4",
            "textDe": "Diese Person verbessert ihr Deutsch mit KI-Hilfe.",
            "textAr": "تطوّر ألمانيّتها بمساعدة KI.",
            "correctAd": "A"
          },
          {
            "id": "lesen-10-1-5",
            "textDe": "Diese Person sorgt sich um die Kinder und KI.",
            "textAr": "قلقٌ على الأطفال.",
            "correctAd": "D"
          },
          {
            "id": "lesen-10-1-6",
            "textDe": "Diese Person sagt: Am Ende entscheidet der Mensch.",
            "textAr": "القرار الأخير للإنسان.",
            "correctAd": "C"
          }
        ]
      },
      {
        "type": "mc-article",
        "title": "Teil 2 – مقالة: الأمن الرقمي",
        "instructionsAr": "اقرأ المقالة واختر a أو b أو c.",
        "textDe": "Phishing-Mails werden immer raffinierter. Früher erkannte man Betrug an schlechtem Deutsch und seltsamen Adressen. Heute sind die Mails fehlerfrei und sehen aus wie echte Briefe von der Bank, dem Finanzamt oder DHL. Allein 2024 verloren Deutsche durch Online-Betrug über 270 Millionen Euro.\n\nWichtige Regeln: Klicken Sie niemals auf Links in verdächtigen Mails. Geben Sie keine Passwörter oder TAN-Codes preis – seriöse Firmen fragen nie danach. Bei Zweifel rufen Sie die Bank direkt an (nicht über die Nummer in der Mail!).\n\nAuch ältere Menschen werden oft mit dem \"Enkeltrick\" angerufen. Ein Betrüger behauptet, er sei der Enkel und brauche dringend Geld. Tipp: Vereinbaren Sie ein Familien-Passwort, das nur echte Verwandte kennen.",
        "questions": [
          {
            "id": "lesen-10-2-1",
            "promptDe": "Was war früher ein Zeichen für Betrug?",
            "options": [
              {
                "id": "a",
                "de": "Schlechtes Deutsch in der Mail."
              },
              {
                "id": "b",
                "de": "Eine bekannte Bank-Adresse."
              },
              {
                "id": "c",
                "de": "Eine Unterschrift am Ende."
              }
            ],
            "correct": "a",
            "explanation": "\"erkannte man Betrug an schlechtem Deutsch\"."
          },
          {
            "id": "lesen-10-2-2",
            "promptDe": "Was sollte man bei verdächtigen Mails tun?",
            "options": [
              {
                "id": "a",
                "de": "Auf den Link klicken zum Prüfen."
              },
              {
                "id": "b",
                "de": "Nicht auf Links klicken."
              },
              {
                "id": "c",
                "de": "Sofort das Passwort eingeben."
              }
            ],
            "correct": "b"
          },
          {
            "id": "lesen-10-2-3",
            "promptDe": "Wenn die Bank ein Passwort verlangt:",
            "options": [
              {
                "id": "a",
                "de": "Schnell senden."
              ...
              {
                "id": "b",
                "de": "Es kann kein echter Anruf sein."
              },
              {
                "id": "c",
                "de": "In der Mail antworten."
              }
            ],
            "correct": "b",
            "explanation": "\"seriöse Firmen fragen nie danach\"."
          },
          {
            "id": "lesen-10-2-4",
            "promptDe": "Beim Enkeltrick:",
            "options": [
              {
                "id": "a",
                "de": "Ein Betrüger ruft an und behauptet, ein Verwandter zu sein."
              },
              {
                "id": "b",
                "de": "Die Enkel betrügen die Großeltern."
              },
              {
                "id": "c",
                "de": "Die Bank ruft die Familie an."
              }
            ],
            "correct": "a"
          },
          {
            "id": "lesen-10-2-5",
            "promptDe": "Was hilft gegen den Enkeltrick?",
            "options": [
              {
                "id": "a",
                "de": "Mehr Geld auf der Bank."
              },
              {
                "id": "b",
                "de": "Ein Familien-Passwort."
              },
              {
                "id": "c",
                "de": "Den Enkel sofort blockieren."
              }
            ],
            "correct": "b"
          }
      ...
      {
        "type": "mc-rules",
        "title": "Teil 3 – قواعد استخدام مكتبة",
        "instructionsAr": "اقرأ القواعد ثمّ أجب.",
        "textDe": "Bibliotheksordnung — Stadtbibliothek Köln\n\n§1 Anmeldung: Wer Bücher ausleihen möchte, braucht einen gültigen Ausweis. Für Personen unter 18 Jahren ist die Anmeldung kostenlos. Erwachsene zahlen 12 € pro Jahr.\n\n§2 Ausleihfrist: Bücher und Zeitschriften 4 Wochen, DVDs und Spiele 1 Woche. Verlängerung online oder telefonisch möglich, wenn niemand anderes das Werk reserviert hat.\n\n§3 Gebühren bei Verspätung: 0,20 € pro Tag und Werk. Nach 4 Wochen Mahnung schriftlich, dann Sperrung des Kontos.\n\n§4 Verlorene oder beschädigte Werke müssen ersetzt werden. Bei seltenen Büchern wird der Wiederbeschaffungspreis berechnet.\n\n§5 Ruhe im Lesesaal! Telefonate bitte im Foyer. Essen und Trinken (außer Wasser) sind verboten.",
        "questions": [
          {
            "id": "lesen-10-3-1",
            "promptDe": "Wie viel zahlt ein 25-Jähriger pro Jahr?",
            "options": [
              {
                "id": "a",
                "de": "Nichts."
          ...
          {
            "id": "lesen-10-3-2",
            "promptDe": "Wie lange darf man DVDs behalten?",
            "options": [
              {
                "id": "a",
                "de": "4 Wochen."
          ...
          {
            "id": "lesen-10-3-3",
            "promptDe": "Wann ist Verlängerung NICHT möglich?",
            "options": [
              {
                "id": "a",
                "de": "Wenn ein anderer das Werk reserviert hat."
              },
              {
                "id": "b",
                "de": "Im Sommer."
          ...
          {
            "id": "lesen-10-3-4",
            "promptDe": "Was kostet 5 Tage Verspätung mit einem Buch?",
            "options": [
              {
                "id": "a",
                "de": "0,50 €."
            ...
            "correct": "b",
            "explanation": "5 × 0,20 € = 1,00 €."
          },
          {
            "id": "lesen-10-3-5",
            "promptDe": "Wo darf man telefonieren?",
            "options": [
              {
                "id": "a",
                "de": "Überall."
  ...
  {
    "id": "lesen-11",
    "title": "Lesen 11 – الصحّة والرياضة",
    "description": "مقال عن النوم، مدوّنات عن الرياضة، إعلانات صالات لياضة، وحوار طبّي.",
    "parts": [
      {
        "type": "mc-article",
        "title": "Teil 1 – مقال: أهمّية النوم",
        "instructionsAr": "اقرأ المقال واختر a أو b أو c.",
        "textDe": "Schlaf ist genauso wichtig wie gesunde Ernährung und Sport — aber viele Deutsche schlafen zu wenig. Eine Studie der Krankenkasse DAK zeigt: Mehr als ein Drittel der Erwachsenen schläft weniger als 6 Stunden pro Nacht. Empfohlen werden 7-9 Stunden.\n\nFolgen von Schlafmangel sind erheblich: Konzentrationsschwäche, schlechtere Laune, ein höheres Risiko für Herzkrankheiten und Diabetes. Im Straßenverkehr sind Müdigkeitsunfälle eine der häufigsten Unfallursachen.\n\nWas hilft? Experten empfehlen: keine Handys oder Bildschirme eine Stunde vor dem Schlafen, ein kühles Schlafzimmer (16-18°C), regelmäßige Schlafenszeiten — auch am Wochenende. Wer länger als zwei Wochen schlecht schläft, sollte einen Arzt aufsuchen.",
        "questions": [
          {
            "id": "lesen-11-1-1",
            "promptDe": "Wie viel Schlaf empfehlen Experten?",
            "options": [
              {
                "id": "a",
                "de": "5-6 Stunden."
          ...
          {
            "id": "lesen-11-1-2",
            "promptDe": "Was ist eine Folge von Schlafmangel?",
            "options": [
              {
                "id": "a",
                "de": "Bessere Laune."
              ...
              {
                "id": "b",
                "de": "Höheres Risiko für Diabetes."
              },
              {
                "id": "c",
                "de": "Stärkere Knochen."
          ...
          {
            "id": "lesen-11-1-3",
            "promptDe": "Was sollte man vor dem Schlafen vermeiden?",
            "options": [
              {
                "id": "a",
                "de": "Eine Stunde lesen."
              },
              {
                "id": "b",
                "de": "Bildschirme nutzen."
              },
              {
                "id": "c",
                "de": "Das Zimmer lüften."
              }
            ],
            "correct": "b"
          },
          {
            "id": "lesen-11-1-4",
            "promptDe": "Wie warm sollte das Schlafzimmer sein?",
            "options": [
              {
                "id": "a",
                "de": "12-14°C."
          ...
          {
            "id": "lesen-11-1-5",
            "promptDe": "Wann sollte man zum Arzt gehen?",
            "options": [
              {
                "id": "a",
                "de": "Sofort nach einer schlechten Nacht."
              },
              {
                "id": "b",
                "de": "Wenn man länger als 2 Wochen schlecht schläft."
              },
              {
                "id": "c",
                "de": "Nur bei Fieber."
      ...
      {
        "type": "match-blog",
        "title": "Teil 2 – مدوّنات عن الرياضة",
        "instructionsAr": "اقرأ 5 مشاركات عن \"كيف أبقى رياضيّاً\" واختر من أيّ شخص الجملة (6 جمل).",
        "texts": [
          {
            "id": "A",
            "titleDe": "Aisha",
            "titleAr": "عائشة",
            "textDe": "Ich gehe dreimal pro Woche zum Fitnessstudio nach der Arbeit. Es kostet 30 € im Monat. Dort treffe ich auch Freundinnen."
          },
          {
            "id": "B",
            "titleDe": "Bilal",
            "titleAr": "بلال",
            "textDe": "Sport im Studio ist mir zu teuer. Ich jogge im Park und mache zu Hause YouTube-Workouts. Mein Hund kommt immer mit beim Laufen."
          },
          {
            "id": "C",
            "titleDe": "Christine",
            "titleAr": "كريستين",
            "textDe": "Mit 65 fahre ich jeden Tag Fahrrad zur Apotheke und zum Markt. Auto brauche ich nicht. Mein Arzt sagt, ich bin fitter als viele 40-Jährige."
          },
          {
            "id": "D",
            "titleDe": "Diana",
            "titleAr": "ديانا",
            "textDe": "Ich habe drei kleine Kinder und keine Zeit für Sport. Aber ich spiele mit ihnen im Garten — das ist auch Bewegung!"
          },
          {
            "id": "E",
            "titleDe": "Erkan",
            "titleAr": "إركان",
            "textDe": "Ich war Fußballer in der Türkei. Hier in Deutschland spiele ich am Samstag in einem syrisch-türkischen Verein. Das ist soziales Treffen + Sport."
          }
        ],
        "statements": [
          {
            "id": "lesen-11-2-1",
            "textDe": "Diese Person macht Sport mit den eigenen Kindern.",
            "textAr": "يمارس الرياضة مع أطفاله.",
            "correctAd": "D"
          },
          {
            "id": "lesen-11-2-2",
            "textDe": "Diese Person nutzt das Fahrrad statt Auto.",
            "textAr": "يستخدم الدرّاجة بدل السيّارة.",
            "correctAd": "C"
          },
          {
            "id": "lesen-11-2-3",
            "textDe": "Diese Person bringt ein Tier mit beim Sport.",
            "textAr": "يصطحب حيواناً.",
            "correctAd": "B"
          },
          {
            "id": "lesen-11-2-4",
            "textDe": "Diese Person trainiert in einer Gruppe von Migranten.",
            "textAr": "يتمرّن في فريق مهاجرين.",
            "correctAd": "E"
          },
          {
            "id": "lesen-11-2-5",
            "textDe": "Diese Person zahlt für ein Fitnessstudio.",
            "textAr": "يدفع لصالة رياضيّة.",
            "correctAd": "A"
          },
          {
            "id": "lesen-11-2-6",
            "textDe": "Diese Person ist über 60 Jahre alt.",
            "textAr": "أكبر من 60 سنة.",
            "correctAd": "C"
          }
        ]
      },
      {
        "type": "tf-opinions",
        "title": "Teil 3 – آراء: التدخين",
        "instructionsAr": "اقرأ النصّ وحدّد: صحيح (R) أم خطأ (F).",
        "textDe": "Forum: Sollte Rauchen in Restaurants verboten bleiben?\n\n**Anna:** Ja, unbedingt! Als Mutter will ich nicht, dass meine Kinder Zigarettenrauch einatmen. Frische Luft ist ein Grundrecht.\n\n**Boris:** Ich bin Raucher seit 30 Jahren. Wenn ich nicht draußen rauchen darf, gehe ich in keine Bar mehr. Das ist nicht fair für die Wirte.\n\n**Carla:** Die Statistik zeigt: Seit dem Rauchverbot in Gaststätten ist die Zahl der Herzinfarkte gesunken. Das ist Fakt — Schluss mit der Diskussion.",
        "questions": [
          {
            "id": "lesen-11-3-1",
            "statementDe": "Anna will frische Luft für ihre Kinder.",
            "correct": true
          },
          {
            "id": "lesen-11-3-2",
            "statementDe": "Anna findet das Rauchverbot unwichtig.",
            "correct": false
          },
          {
            "id": "lesen-11-3-3",
            "statementDe": "Boris möchte das Rauchen erlaubt sehen.",
            "correct": true
          },
          {
            "id": "lesen-11-3-4",
            "statementDe": "Boris geht jetzt mehr in Bars als früher.",
            "correct": false,
            "explanation": "\"gehe ich in keine Bar mehr\"."
          },
          {
            "id": "lesen-11-3-5",
            "statementDe": "Carla zitiert eine Statistik über Herzinfarkte.",
            "correct": true
          }
        ]
      }
