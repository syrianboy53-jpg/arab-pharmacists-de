export const schreibenModels = [
  ...
  {
    "id": "schreiben-10",
    "title": "Schreiben 10 – التواصل الرقمي",
    "description": "ثلاث مهامّ كتابيّة عن البريد الإلكتروني والتطبيقات الرقميّة.",
    "tasks": [
      {
        "id": "schreiben-10-1",
        "taskNumber": 1,
        "typeAr": "بريد لصديق عن مشكلة تقنيّة",
        "typeDe": "E-Mail an einen Freund über ein Technik-Problem",
        "promptAr": "إخوتك يطلبون منك مساعدة. حاسوبك لا يعمل ولا تستطيع تسليم واجب الجامعة. اكتب لصديقك يوسف.",
        ...
        "requirements": [
          "اشرح المشكلة",
          "اسأل عن مساعدة (هل يمكنك استخدام حاسوبه؟)",
          "حدّد متى تريد المجيء",
          "اطلب الردّ السريع"
        ],
        "wordCount": "حوالي 80 كلمة",
        "usefulPhrases": [
          ...
          },
          {
            ...
            "ar": "هل أستطيع أن آتي اليوم لأستخدم حاسوبك؟"
          },
          {
            "de": "Ich muss die Hausaufgabe bis morgen abgeben.",
            "ar": "يجب أن أسلّم الواجب غداً."
          },
          {
            "de": "Bitte antworte schnell!",
            "ar": "أرجو الردّ سريعاً!"
          }
        ],
      ...
      },
      {
        "id": "schreiben-10-2",
        "taskNumber": 2,
        "typeAr": "تقييم منتج اشتريته إلكترونيّاً",
        "typeDe": "Bewertung eines online gekauften Produkts",
        "promptAr": "اشتريت سمّاعة بلوتوث من Amazon لكنّ الجودة سيّئة. اكتب تقييماً موضوعيّاً.",
        ...
        "requirements": [
          "اذكر اسم المنتج وتاريخ الشراء",
          "اشرح ثلاث مشاكل واجهتها",
          "اذكر شيئاً إيجابياً (إن وجد)",
          "وصِ أو لا توصِ بالمنتج للآخرين"
        ],
        "wordCount": "حوالي 100-120 كلمة",
        "usefulPhrases": [
          {
            "de": "Ich habe den Kopfhörer am ... gekauft.",
            "ar": "اشتريت السمّاعة في..."
          },
          {
            "de": "Leider bin ich enttäuscht.",
            "ar": "للأسف أنا مخيّب الأمل."
          },
          {
            "de": "Der Akku hält nur ...",
            "ar": "البطّاريّة تدوم فقط..."
          },
          {
            "de": "Die Soundqualität ist mittelmäßig.",
            "ar": "جودة الصوت متوسّطة."
          },
          {
      ...
      },
      {
        "id": "schreiben-10-3",
        "taskNumber": 3,
        "typeAr": "طلب الغاء اشتراك إلكتروني",
        "typeDe": "Schriftliche Kündigung eines Online-Abos",
        "promptAr": "تريد إلغاء اشتراك Netflix الذي تدفع فيه 17,99 € شهريّاً. اكتب لخدمة العملاء.",
        "promptDe": "Sie möchten Ihr Netflix-Abo für 17,99 € im Monat kündigen. Schreiben Sie an den Kundenservice.",
        "requirements": [
          "اذكر بياناتك ورقم الاشتراك",
          "اطلب الإلغاء صراحةً",
          "حدّد التاريخ المطلوب للإنهاء",
          "اطلب تأكيداً كتابيّاً"
        ],
        ...
        "usefulPhrases": [
          ...
          },
          {
            ...
            "ar": "بهذا ألغي اشتراكي بأقرب فرصة."
          },
          {
          ...
          },
          {
            ...
            "ar": "أرجو التأكيد كتابيّاً."
          },
          {
            "de": "Bitte stornieren Sie auch zukünftige Abbuchungen.",
            "ar": "أرجو إيقاف الخصومات المستقبليّة."
          }
        ],
  ...
  {
    "id": "schreiben-11",
    "title": "Schreiben 11 – المواقف الرسميّة",
    "description": "مهامّ كتابة رسميّة: شكوى لشركة، طلب موعد، رفض دعوة بأدب.",
    "tasks": [
      {
        "id": "schreiben-11-1",
        "taskNumber": 1,
        "typeAr": "شكوى لشركة الكهرباء",
        "typeDe": "Beschwerde beim Stromanbieter",
        "promptAr": "فاتورة الكهرباء عاليّة جدّاً هذا الشهر (350 € بدل 90 €). اكتب شكوى رسميّة.",
        "promptDe": "Ihre Stromrechnung ist in diesem Monat sehr hoch (350 € statt 90 €). Schreiben Sie eine formelle Beschwerde.",
        "requirements": [
          "اذكر رقم الزبون والعداد",
          "اشرح المشكلة بدقّة",
          "اطلب فحص العداد",
          "حدّد مهلة للردّ"
        ],
        ...
        "usefulPhrases": [
          ...
          },
          {
            ...
            "ar": "باستغراب كبير تلقّيت فاتورتكم."
          },
          {
            "de": "Meine Kundennummer ist ..., der Zählerstand ...",
            "ar": "رقم زبوني... ورقم العدّاد..."
          },
          {
            "de": "Ich kann mir den hohen Betrag nicht erklären.",
            "ar": "لا أستطيع تفسير المبلغ الكبير."
          },
          {
          ...
          },
          {
            ...
            "ar": "حتّى التوضيح أرجو وقف الخصم."
          },
          {
            "de": "Ich erwarte Ihre Antwort innerhalb von 14 Tagen.",
            "ar": "أنتظر ردّكم خلال 14 يوماً."
          }
        ],
      ...
      },
      {
        "id": "schreiben-11-2",
        "taskNumber": 2,
        "typeAr": "طلب موعد لدى الطبيب",
        "typeDe": "Terminanfrage beim Arzt",
        "promptAr": "تعاني من ألم في الظهر منذ أسبوع. اكتب بريداً لعيادة الطبيب لطلب موعد عاجل.",
        ...
        "requirements": [
          "اذكر اسمك وتاريخ ميلادك",
          "صف الأعراض",
          "اقترح موعداً (مع بدائل)",
          "اذكر شركة التأمين"
        ],
        "wordCount": "حوالي 80 كلمة",
        "usefulPhrases": [
          ...
          },
          {
            ...
            "ar": "أستطيع من الإثنين للجمعة بعد الـ16."
          },
          {
      ...
      },
      {
        ...
        "promptAr": "دعتك جارتك السيّدة شميدت لحفلة عيد ميلاد ابنتها. لا تستطيع الحضور. اكتب رسالة قصيرة.",
