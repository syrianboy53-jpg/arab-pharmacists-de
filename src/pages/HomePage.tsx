    ...
    <div className="space-y-6 pb-8">
      ...
      <section className="relative rounded-3xl overflow-hidden">
        ...
        <div className="relative z-10 p-6 sm:p-10">
          <div className="flex items-center gap-2 mb-4">
            <span className="inline-flex items-center gap-1.5 bg-white/10 backdrop-blur-sm text-white/90 text-xs font-medium px-3 py-1.5 rounded-full border border-gray-200 dark:border-white/10">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/daily" className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-all backdrop-blur-sm border border-gray-200 dark:border-white/10">
              📅 تحدّي اليوم
            </Link>
            <button onClick={handleShareApp} className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-all backdrop-blur-sm border border-gray-200 dark:border-white/10 cursor-pointer">
              📢 شارك
            </button>
          </div>
        </div>
      ...
      <section className="grid grid-cols-4 gap-2 sm:gap-3">
        {[
          ...
          <div key={i} className="bg-white dark:bg-[#1a1a2e] rounded-2xl p-3 text-center border border-gray-100 dark:border-white/5 hover:border-gray-200 dark:border-white/10 dark:hover:border-gray-200 dark:border-white/10 transition-colors">
