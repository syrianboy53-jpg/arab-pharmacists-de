    ...
    return (
      <div className="p-4 max-w-3xl mx-auto mb-20 animate-slide-up">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full text-sm font-bold text-gray-600 dark:text-gray-300">1 / 4</span>
        </div>
        
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
          <h3 className="font-bold text-lg mb-4 dark:text-white border-b pb-2 dark:border-gray-700">Teil 1: Lesen Sie den Text.</h3>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl border-l-4 border-blue-500 text-left" dir="ltr">
            Liebe Sarah,<br/><br/>
    ...
    return (
      <div className="p-4 max-w-3xl mx-auto mb-20 animate-slide-up">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full text-sm font-bold text-gray-600 dark:text-gray-300">2 / 4</span>
        </div>
        
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
          <h3 className="font-bold text-lg mb-4 dark:text-white border-b pb-2 dark:border-gray-700">Teil 1: Hören Sie die Ansage.</h3>
          
          <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-xl text-center mb-6 border border-gray-200 dark:border-gray-700">
    ...
    return (
      <div className="p-4 max-w-3xl mx-auto mb-20 animate-slide-up">
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-full text-sm font-bold text-gray-600 dark:text-gray-300">3 / 4</span>
        </div>
        
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
          <h3 className="font-bold text-lg mb-4 dark:text-white border-b pb-2 dark:border-gray-700">Schreiben Sie eine E-Mail</h3>
          ...
          <textarea 
            className="w-full h-48 p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none resize-none text-left dark:text-white font-sans"
            placeholder="Liebe(r)..."
            dir="ltr"
          ></textarea>
  ...
  if (currentSection === 'sprechen') {
    return (
      <div className="p-4 max-w-3xl mx-auto mb-20 animate-slide-up">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 mb-6">
          <h3 className="font-bold text-lg mb-4 dark:text-white border-b pb-2 dark:border-gray-700">Teil 2: Etwas gemeinsam planen</h3>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6 text-left" dir="ltr">
