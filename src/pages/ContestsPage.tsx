...
export default function ContestsPage() {return (
    <div className="space-y-6">
      <h1 className="text-2xl font-black flex items-center gap-2 text-gray-900 dark:text-gray-900 dark:text-white">🎁 مسابقات بجوائز</h1>
      <div className="bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl p-6 text-white">
        <div className="text-3xl mb-2">🏅</div>
        <h2 className="text-xl font-bold mb-1 text-gray-800 dark:text-gray-200">مسابقة الأسبوع</h2>
        <p className="text-gray-900 dark:text-white/80 text-sm mb-4">أجب على 20 سؤال — أفضل 3 يحصلون على هدايا</p>
