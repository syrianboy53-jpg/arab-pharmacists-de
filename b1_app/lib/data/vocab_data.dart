// Automatically generated from Web data (vocabulary.ts) on 2026-06-05T17:19:01.891Z
import 'dart:convert';

final List<Map<String, dynamic>> vocabCategories = List<Map<String, dynamic>>.from(json.decode(r'''[
  {
    "id": "apotheke-medizin",
    "titleAr": "الصيدلة والطب",
    "titleDe": "Apotheke & Medizin",
    "words": [
      {
        "de": "die Rezeptpflicht",
        "ar": "وجوب الوصفة الطبية",
        "example": "Dieses Medikament hat Rezeptpflicht (هذا الدواء يتطلب وصفة طبية)."
      },
      {
        "de": "die Nebenwirkung",
        "ar": "الأثر الجانبي للدواء",
        "example": "Welche Nebenwirkungen hat dieses Arzneimittel?"
      },
      {
        "de": "die Dosierung",
        "ar": "جرعة الدواء",
        "example": "Bitte beachten Sie die genaue Dosierung."
      },
      {
        "de": "der Beipackzettel",
        "ar": "النشرة الداخلية للدواء",
        "example": "Lesen Sie den Beipackzettel vor der Einnahme."
      },
      {
        "de": "die Packungsbeilage",
        "ar": "النشرة المرفقة بالعبوة",
        "example": "Die Packungsbeilage enthält wichtige Hinweise."
      },
      {
      ...
      },
      {
        "de": "das Antibiotikum",
        "ar": "المضاد الحيوي",
        "example": "Antibiotika darf man nur mit Rezept kaufen."
      },
      {
        "de": "die Wechselwirkung",
        "ar": "التداخل الدوائي",
        "example": "Gibt es Wechselwirkungen mit anderen Medikamenten?"
      },
      {
        "de": "das Blutdruckmessgerät",
        "ar": "جهاز قياس ضغط الدم",
        "example": "Ich muss den Blutdruck mit dem Gerät messen."
      },
      {
        "de": "die Salbe",
        "ar": "المرهم الطبي",
      ...
      },
      {
        "de": "die Einnahme",
        "ar": "تناول الدواء",
        "example": "Die Einnahme sollte vor dem Essen erfolgen."
      },
      {
        "de": "das Desinfektionsmittel",
        "ar": "المطهر / المعقم",
        "example": "Desinfektionsmittel tötet Bakterien ab."
      },
      {
        "de": "die Spritze",
        "ar": "الحقنة الطبية",
        "example": "Der Arzt gibt dem Patienten eine Spritze."
      },
      {
        "de": "der Hustensaft",
        "ar": "شراب السعال",
        "example": "Nehmen Sie den Hustensaft bei Reizhusten."
      },
      {
        "de": "die Apotheke",
        "ar": "الصيدلية",
        "example": "Ich hole mein Medikament aus der Apotheke."
      },
      {
        "de": "das Rezept",
        "ar": "الوصفة الطبية (الروشتة)",
        "example": "Der Arzt schreibt mir ein Rezept für die Tabletten."
      }
    ]
  },
  {
    ...
    "words": [
      ...
      },
      {
        "de": "der Alltag",
        "ar": "الحياة اليومية",
        "example": "Im Alltag lernt man Deutsch (في الحياة اليومية يتعلم المرء الألمانية)."
      },
      {
        "de": "die Gewohnheit",
        "ar": "العادة",
        "example": "Er hat eine gute Gewohnheit (لديه عادة حسنة)."
      }
    ]
  },
  {
    "id": "arbeit",
    "titleAr": "العمل والوظيفة",
    ...
    "words": [
      ...
      },
      {
        "de": "die Überstunden",
        "ar": "الساعات الإضافية",
        "example": "Ich mache heute Überstunden (سأعمل ساعات إضافية اليوم)."
      },
      {
        "de": "die Kündigung",
        "ar": "الاستقالة/الإقالة",
        "example": "Sie hat die Kündigung eingereicht (قدمت استقالتها)."
      }
    ]
  },
  {
    "id": "wohnen",
    "titleAr": "السكن والبيت",
    "titleDe": "Wohnen",
    "words": [
      {
        "de": "die Wohnung",
  ...
  },
  {
    ...
    "words": [
      ...
      },
      {
        ...
        "example": "Geben Sie mir bitte Ihre Versichertenkarte (أعطني بطاقة تأمينك الصحي من فضلك)."
      },
      {
        "de": "die Krankschreibung",
        "ar": "الإجازة المرضية",
        "example": "Ich brauche eine Krankschreibung für den Arbeitgeber (أحتاج إجازة مرضية لرب العمل)."
      }
    ]
  },
  {
    "id": "behoerden",
    "titleAr": "الدوائر الرسمية",
    ...
    "words": [
      ...
      {
        "de": "der Bescheid",
        "ar": "القرار/الإشعار الرسمي",
        "example": "Ich habe den Bescheid vom Jobcenter bekommen (استلمت قرار جوب سنتر)."
      },
      {
        "de": "die Aufenthaltserlaubnis",
        "ar": "تصريح الإقامة",
        "example": "Meine Aufenthaltserlaubnis wurde verlängert (تم تمديد تصريح إقامتي)."
      }
    ]
  },
  {
    "id": "schule",
    "titleAr": "المدرسة والتعليم",
    ...
    "words": [
      ...
      },
      {
        "de": "die Nachhilfe",
        "ar": "الدروس الخصوصية",
        "example": "Das Kind braucht Nachhilfe in Mathe (الطفل يحتاج لدروس خصوصية في الرياضيات)."
      }
    ]
  },
  {
    ...
    "words": [
      ...
      },
      {
        "de": "der Fahrplan",
        "ar": "جدول الرحلات",
        "example": "Ich muss den Fahrplan überprüfen (يجب أن أتحقق من جدول الرحلات)."
      }
    ]
  },
  {
    ...
    "words": [
      ...
      },
      {
        "de": "der Kassenbon",
        "ar": "إيصال الشراء",
        "example": "Möchten Sie den Kassenbon haben? (هل تريد إيصال الشراء؟)"
      }
    ]
  },
  {
    "id": "freizeit",
    "titleAr": "أوقات الفراغ",
    "titleDe": "Freizeit",
    "words": [
      {
        "de": "der Sport",
      ...
      },
      {
        "de": "die Erholung",
        "ar": "الاستجمام/الراحة",
        "example": "Nach der Arbeit brauche ich Erholung (بعد العمل أحتاج إلى استجمام)."
      },
      {
        "de": "die Mitgliedschaft",
        "ar": "العضوية",
        "example": "Ich habe eine Mitgliedschaft im Fitnessstudio (لدي عضوية في النادي الرياضي)."
      }
    ]
  },
  {
    "id": "konnektoren",
    "titleAr": "أدوات الربط المهمة",
    "titleDe": "Wichtige Konnektoren",
    "words": [
      {
        "de": "weil",
  ...
  {
    "id": "meinung",
    "titleAr": "عبارات للتعبير عن الرأي",
    "titleDe": "Meinung ausdrücken",
    "words": [
      {
        "de": "Ich finde, dass …",
        "ar": "أجد أن ..."
      ...
      },
      {
        "de": "Meiner Meinung nach",
        "ar": "حسب رأيي",
        "example": "Meiner Meinung nach ist Deutsch einfach (حسب رأيي فإن الألمانية سهلة)."
      },
      {
        "de": "Ich bin der Ansicht, dass",
        "ar": "أنا من رأيي أن",
        "example": "Ich bin der Ansicht, dass wir lernen müssen (أنا من رأيي أنه يجب أن نتعلم)."
      }
    ]
  },
  {
    "id": "koerper",
    "titleAr": "الجسم والصحة (موسّع)",
    "titleDe": "Körper & Gesundheit",
    "words": [
      {
        "de": "der Kopf",
        "ar": "الرأس",
      ...
      },
      {
        "de": "das Gelenk",
        "ar": "المفصل",
        "example": "Meine Gelenke tun weh (مفاصلي تؤلمني)."
      },
      {
        "de": "die Durchblutung",
        "ar": "الدورة الدموية",
        "example": "Sport verbessert die Durchblutung (الرياضة تحسن الدورة الدموية)."
      }
    ]
  },
  {
    "id": "geld",
    "titleAr": "المال والبنك",
    "titleDe": "Geld & Bank",
    "words": [
      {
        "de": "das Geld",
      ...
      },
      {
        "de": "das Sparkonto",
        "ar": "حساب التوفير",
        "example": "Ich zahle Geld auf mein Sparkonto ein (أودع مالاً في حساب التوفير الخاص بي)."
      },
      {
        "de": "die Zinsen",
        "ar": "الفوائد",
        "example": "Die Bank zahlt gute Zinsen (البنك يدفع فوائد جيدة)."
      }
    ]
  },
  {
    "id": "amt",
    "titleAr": "الإدارة والمكاتب الرسمية ⭐",
  ...
  },
  {
    ...
    "words": [
      ...
      },
      {
        "de": "die Rückgabe",
        "ar": "الإرجاع",
        "example": "Die Rückgabe ist innerhalb von 14 Tagen möglich (الإرجاع ممكن خلال 14 يوماً)."
      }
    ]
  },
  {
    "id": "gefuehle",
    "titleAr": "المشاعر والصفات الشخصية",
    "titleDe": "Gefühle & Charakter",
    "words": [
      {
        "de": "glücklich / froh",
        "ar": "سعيد / مسرور",
      ...
      },
      {
        "de": "die Enttäuschung",
        "ar": "الخيبة/الخذلان",
        "example": "Das war eine große Enttäuschung (كانت تلك خيبة أمل كبيرة)."
      },
      {
        "de": "die Erleichterung",
        "ar": "الارتياح",
        "example": "Nach der Prüfung spürte ich Erleichterung (بعد الامتحان شعرت بالارتياح)."
      }
    ]
  },
  {
    "id": "haushalt",
    "titleAr": "المنزل والأثاث",
    "titleDe": "Haushalt & Möbel",
    "words": [
      {
        "de": "das Wohnzimmer",
        "ar": "غرفة المعيشة",
      ...
      },
      {
        ...
        "example": "Der Staubsauger ist kaputt (المكنسة الكهربائية معطلة)."
      }
    ]
  },
  {
    "id": "umwelt",
    "titleAr": "البيئة والطقس",
    "titleDe": "Umwelt & Wetter",
    "words": [
      {
        "de": "das Wetter",
        "ar": "الطقس",
      ...
      },
      {
        "de": "der Umweltschutz",
        "ar": "حماية البيئة",
        "example": "Umweltschutz beginnt im Alltag (حماية البيئة تبدأ في الحياة اليومية)."
      }
    ]
  },
  {
    "id": "zeit",
    "titleAr": "الزمن والمناسبات",
    "titleDe": "Zeit & Anlässe",
    "words": [
      {
      ...
      {
        "de": "die Frist",
        "ar": "المهلة/الموعد الأخير",
        "example": "Die Frist endet morgen (المهلة تنتهي غداً)."
      },
      {
        "de": "die Dauer",
        "ar": "المدة",
        "example": "Die Dauer des Kurses beträgt sechs Monate (مدة الدورة تبلغ ستة أشهر)."
      }
    ]
  },
  {
    "id": "essen2",
    "titleAr": "المطبخ والمأكولات",
    ...
    "words": [
      ...
      },
      {
        "de": "die Zutat",
        "ar": "المكوّن للمقادير",
        "example": "Welche Zutaten braくい für den Kuchen? (ما هي المكونات التي أحتاجها للكعكة؟)"
      },
      {
        "de": "das Rezept",
        "ar": "وصفة الطبخ / الطريقة",
        "example": "Das Rezept ist sehr einfach (وصفة الطبخ سهلة جداً)."
      }
    ]
  },
  {
    "id": "arzt",
    "titleAr": "عند الطبيب والصيدلية",
    "titleDe": "Beim Arzt und in der Apotheke",
    "words": [
      {
        "de": "der Termin",
        "ar": "موعد",
  ...
  {
    "id": "auto-verkehr",
    "titleAr": "السيارة والقيادة",
    "titleDe": "Auto und Verkehr",
    "words": [
      {
        "de": "der Führerschein",
        "ar": "رخصة القيادة",
      ...
      },
      {
        ...
        "ar": "رخصة القيادة",
        "example": "Ich habe meine Fahrerlaubnis bestanden (لقد نجحت في رخصة القيادة)."
      }
    ]
  },
  {
  ...
  {
    "id": "post-amt",
    "titleAr": "البريد والمعاملات",
    "titleDe": "Post und Behörden",
    "words": [
      {
        "de": "die Post",
      ...
      },
      {
        ...
        "ar": "تتبع الشحنة",
        "example": "Mit der Sendungsverfolgung sehe ich mein Paket (مع تتبع الشحنة أرى طردي)."
      },
      {
        "de": "der Einschreibebrief",
        "ar": "الرسالة المسجلة",
        "example": "Ich schicke die Kündigung als Einschreiben (سأرسل الاستقالة كرسالة مسجلة)."
      }
    ]
  },
  {
    "id": "medien-internet",
    "titleAr": "الإعلام والإنترنت",
    "titleDe": "Medien und Internet",
    "words": [
      {
      ...
      },
      {
        "de": "die Suchmaschine",
        "ar": "محرك البحث",
        "example": "Google ist die größte Suchmaschine (جوجل هو أكبر محرك بحث)."
      },
      {
        "de": "die Verbindung",
        "ar": "الاتصال/الشبكة",
        "example": "Die Internetverbindung ist sehr langsam (اتصال الإنترنت بطيء جداً)."
      }
    ]
  },
  {
    "id": "reisen-urlaub",
    "titleAr": "السفر والإجازات",
    ...
    "words": [
      ...
      },
      {
        "de": "die Buchung",
        "ar": "الحجز",
        "example": "Ich habe die Buchung bestätigt (لقد أكدت الحجز)."
      },
      {
        "de": "die Unterkunft",
        "ar": "مكان الإقامة/السكن",
        "example": "Wir suchen eine günstige Unterkunft (نبحث عن سكن رخيص)."
      }
    ]
  },
  {
    "id": "arbeit-bewerbung",
    "titleAr": "التقديم للعمل",
    "titleDe": "Bewerbung und Vorstellungsgespräch",
    "words": [
      {
      ...
      },
      {
        "de": "der Lebenslauf",
        "ar": "السيرة الذاتية",
        "example": "Ich muss meinen Lebenslauf aktualisieren (يجب أن أحدث سيرتي الذاتية)."
      }
    ]
  },
  {
    ...
    "words": [
      ...
      },
      {
        "de": "die Mülltrennung",
        "ar": "فرز النفايات",
        "example": "Mülltrennung ist wichtig in Deutschland (فرز النفايات مهم في ألمانيا)."
      }
    ]
  }
]'''));
